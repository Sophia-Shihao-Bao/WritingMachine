...
#define DOT_UP_DELAY 150    //打点等待时间  
#define DOT_DOWN_DELAY 150   //打点等待时间   //要符合舵机动作幅度的时间，延时过小会导致无法打到

#define DOT_UP 70     //打点舵机提升到的位置，让笔刚好贴到纸上，不能抬的幅度过高
#define DOT_DOWN 100   //下降后的位置
//    
